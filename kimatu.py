...
#     print(f"{hosi_percent(one)} {one}times , {percent(one):.2f}%")
#     print(f"{hosi_percent(two)} {two}times , {percent(two):.2f}%")
#     print(f"{hosi_percent(three)} {three}times , {percent(three):.2f}%")
#     print(f"{hosi_percent(four)} {four}times , {percent(four):.2f}%")
#     print(f"{hosi_percent(five)} {five}times , {percent(five):.2f}%")
#     print(f"{hosi_percent(six)} {six}times , {percent(six):.2f}%")
